       ...
       <div id="container">
           ...
           <!-- 게시글 작성 -->
             <div id = "center_user_content">
                <form name = 'boardForm'>
                  <textarea class="write" name="bcontent" onkeydown="resize(this)" onkeyup="resize(this)" placeholder="무슨 일이 일어나고 있나요?"></textarea>
                  <div id = "write_button">
                ...
                <input type="hidden" name="bno">         
                  ...
                  <c:forEach var="Board" items="${listcontents}">
                     <div id="content_center">
                        ...
                        <c:set var="loginId" value="${sessionScope.userLoginInfo.member_no}"/>
                        <c:choose>
                           <c:when test="${loginId eq Board.uno}">
                              <ul class="one"> 
                                <li><a href="#">menu</a>
                                  <ul>
                                     <li><a onclick="RemoveBoardContent(${Board.bno})">글 삭제</a></li>
                                     <li><a href="#">글 수정</a></li>
                        ...
                        <div id = "autosize_div">
                           <textarea class="autosize" readonly="readonly">${Board.bcontent}</textarea>
                        </div>
